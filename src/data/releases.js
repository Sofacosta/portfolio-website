export const releases = [
  {
    ...
    htmlDescription:
      '<p class="justify-center"> A melting analog acid ride...</p>',
...

  {
    ...
    htmlDescription:
      '<p class="justify-center">Track release Out via <a href="https://kratermusiclabel.bandcamp.com/" rel=noreferrer target=_blank>Krater Music</a>.</p><p class="justify-center"><a href="https://www.youtube.com/watch?v=R4ivqt5uRr4" rel="noreferrer" target="_blank">Video</a></p>',
...

  {
    ...
    releaseDate: new Date('08/28/2020'),
    htmlDescription:
      '<p class="justify-center"> “Portland’s very own Coast2c rounds off proceedings with her take on FMMPC. Part experimental techno, part textured drone, Sofia’s take is like something from Aphex Twin’s Ambient Works distilled through a post Covid-19 lens.."</p>',
...

  {
    ...
    htmlDescription:
      '<p class="justify-center"> “MARTES SOUNDS EP is a collection of excerpts from a live improv session recorded on November 19, 2019. All sounds by Francisco Lozano and Coast2c</p>',
...

  {
    ...
    htmlDescription:
      '<p class="justify-center"> “Something Greater is Invisible” is an EP recorded live on March, 19, 2020. These tracks are selected excerpts of a recording of the live set that was going to presented last week at the Portland Art Museum that was canceled due to the COVID-19 lockdown.</p>',
...

  {
    ...
    releaseDate: new Date('03/20/2020'),
    htmlDescription:
      '<p class="justify-center"> Recorded live on February, 15 ,2020 in collaboration between Pierce B and Coast2c.</p><p class="justify-center"><a href="https://www.youtube.com/watch?v=bV_UATaGpuE" rel="noreferrer" target="_blank">Video</a></p>',
