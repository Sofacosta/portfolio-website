export const events = [
  {
    ...
    shortDescription: 'A conversation between Sisters with Transistors director Lisa Rovner, and arts + technology leader Emmy Parker + Live performances by Frae-Frae: Daughter of Drexciya, Alissa DeRubeis, Coast2c and Omniflux.',
  ...
  },
  {
    ...
    price: 35,
    shortDescription: 'To celebrate forward-pushing live electronic music from left-field techno, seminal electro to nonconformist industrial, bizarre noise and everything in between.',
  ...
  },
  {
    ...
    location: 'Europe',
    shortDescription: 'Woman in technology workshop, Metamachine Fest, Herna, Loftus Hall, Synth Library Prague, EMS, Berlin Community Radio, Fluc + Fluc Wanne, Yucatan, Kontaktor Post Factum.',
    htmlDescription: '<p> 5/4 Woman in technology workshop.Tschechisches Zentrum, Berlin. Superbooth 18 - 5/5 Coastc, Zufu and Hexorcismos. Loftus Hall, Berlin. - 5/9 Metamachine Fest, Prague. - 5/10 Opening Synth Library. Prague. - 5/11 Coast2c, Nick Klein and Myako. Herna, Brno. - 5/17 Fluc + Fluc Wanne, Viena. - 5/18 Yucatan, Vilnus. - 5/25 EMS Residency, Stockholm. - 6/2 Kontaktor Post Factum. Depo, Riga. - 6/5 Berlin Community Radio, Berlin.   </p>',
    infoUrl: '',
    buyUrl: '',
