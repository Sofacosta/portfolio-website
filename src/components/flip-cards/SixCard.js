...
function SixFrontContent() {
  return (
    <img className="object-cover h-full" src="/assets/images/Landscape.png" alt="Landscape" />
  );
}
...
export function SixCardFront() { return <FlipCardBase content={<SixFrontContent />} /> };
export function SixCardBack() { return <FlipCardBase content={<SixBackContent />} /> };